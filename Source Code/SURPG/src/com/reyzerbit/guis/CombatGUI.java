...
public class CombatGUI {
	...
	// This int represents the speed of the slider in milliseconds. 7 is for strong
	// but slow enemies, 5 is for default enemies, 4 is for elite monsters.
	...
	public static void initCombat(int speedNumber, int enemyHealth, int enemyStrength) throws IOException {
		...
		PlaySoundBite.play(
				System.getProperty("user.home") + Feats.separate + "Documents" + Feats.separate + "SURPG"
						+ Feats.separate + "RequiredFiles" + Feats.separate + "audio" + Feats.separate + "Battle.wav",
				false);
